...
class ssp
{
    ...
    static function data_output($columns, $data)
    {
        ...
        for ($i = 0, $ien = count($data); $i < $ien; $i++) {
            ...
            for ($j = 0, $jen = count($columns); $j < $jen; $j++) {
                ...
                $columnnames = explode(" as ",$column['db']);
     ...
     */
    static function filter($request, $columns, &$bindings, $where2)
    {
        $globalSearch = array();
        $columnSearch = array();
        $dtColumns = self::pluck($columns, 'dt');
     ...
     */
    static function simple($request, $sql_details, $table, $primaryKey, $columns, $join, $where)
    {
        $bindings = array();
